...
export const LSPD_RANKS: Record<string, LSPDRank> = {
  cop: {
    ...
    aliases: ["chief"],
    imageUrl: `${BASE}/4_silver_stars.svg`,
    width: 15,
  },
  acop: {
    label: "Assistant Chief of Police",
    aliases: ["assistantchief"],
    imageUrl: `${BASE}/3_silver_stars.svg`,
    width: 15,
  },
  dchief: {
    label: "Deputy Chief",
    aliases: ["deputychief", "dcop"],
    imageUrl: `${BASE}/2_silver_stars.svg`,
    width: 15,
  },
  comm: {
    label: "Commander",
  ...
  cpt: {
    label: "Captain",
    aliases: ["captain"],
    imageUrl: `${BASE}/3-POLICE_Captain.svg`,
    width: 25,
  },
  lt: {
    label: "Lieutenant",
    aliases: ["lieutenant"],
    imageUrl: `${BASE}/4-POLICE_Lieutenant.svg`,
    width: 25,
  },
  fsgt: {
    label: "First Sergeant",
    aliases: ["firstsergeant"],
    imageUrl: `${BASE}/LSPD_First_Sergeant.svg`,
    width: 25,
  },
  sgt: {
    label: "Sergeant",
    aliases: ["sergeant"],
    imageUrl: `${BASE}/6-POLICE_Sergeant.svg`,
    width: 25,
  },
  cpl: {
    label: "Corporal",
    aliases: ["corporal"],
    imageUrl: `${BASE}/LSPD_Corporal.svg`,
    width: 25,
  },
  snr: {
    label: "Senior Officer",
    aliases: ["senior"],
    imageUrl: `${BASE}/LSPD_Senior_Officer.svg`,
    width: 30,
  },
  off: {
    label: "Officer",
    aliases: ["officer"],
    imageUrl: `${BASE}/LSPD_Officer.svg`,
    width: 25,
  },
  psd: {
    label: "Probationary Officer",
    aliases: ["probationary"],
    imageUrl: `${BASE}/Cadet-Probationary_Officer.png`,
    width: 25,
  },
  cdt: {
    label: "Cadet",
    aliases: ["cadet"],
    imageUrl: `${BASE}/Caution_Cadet.png`,
    width: 25,
  },
};
